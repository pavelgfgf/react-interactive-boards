      ...
      <div className="px-12 py-8">
        ...
        <div className="flex gap-8 mt-12">
          <div className="flex-[60] space-y-6">
            <div className="bg-white rounded-lg border-l-4 border-[#0D69AF] border border-[#E5E7EB] p-6">
              <div className="flex items-start gap-4 mb-4">
                <FileText size={32} className="text-[#0D69AF]" />
                <h3 className="font-bold" style={{ fontSize: '22px' }}>Документы для поступления</h3>
              </div>
              <ul className="space-y-2 text-[#6B7280] ml-12" style={{ fontSize: '16px' }}>
            ...
            <div className="bg-white rounded-lg border-l-4 border-[#0D69AF] border border-[#E5E7EB] p-6">
              <div className="flex items-start gap-4 mb-4">
                <Calendar size={32} className="text-[#0D69AF]" />
            ...
            <div className="bg-white rounded-lg border-l-4 border-[#0D69AF] border border-[#E5E7EB] p-6">
              <div className="flex items-start gap-4 mb-4">
                <Phone size={32} className="text-[#0D69AF]" />
          ...
          <div className="flex-[40]">
            <div className="bg-[#EAF4FB] rounded-lg p-8 flex flex-col items-center justify-center" style={{ height: '600px' }}>
              <h3 className="font-bold text-center mb-8 text-[#0D69AF]" style={{ fontSize: '28px' }}>
                Готовы поступить?
              </h3>
              ...
              <a
                href="#"
                className="text-[#0D69AF] hover:underline text-center"
                style={{ fontSize: '16px' }}
              >
