import { Camera, CheckCircle2, GraduationCap, Handshake, Users } from 'lucide-react';
        ...
        <div className="flex gap-8 mt-8">
          <div className="flex-[65]">
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white dark:bg-slate-800 rounded-lg border border-[#E5E7EB] dark:border-slate-700 p-5">
                  <div className="flex items-center gap-3 mb-3">
                    <GraduationCap size={26} className="text-[#0D69AF] dark:text-blue-400" />
                ...
                <div className="bg-white dark:bg-slate-800 rounded-lg border border-[#E5E7EB] dark:border-slate-700 p-5">
                  <div className="flex items-center gap-3 mb-3">
                    <Users size={26} className="text-[#0D69AF] dark:text-blue-400" />
                ...
                <div className="bg-white dark:bg-slate-800 rounded-lg border border-[#E5E7EB] dark:border-slate-700 p-5">
                  <div className="flex items-center gap-3 mb-3">
                    <Handshake size={26} className="text-[#0D69AF] dark:text-blue-400" />
                ...
                <div className="bg-white dark:bg-slate-800 rounded-lg border border-[#E5E7EB] dark:border-slate-700 p-5">
                  <div className="flex items-center gap-3 mb-3">
                    <CheckCircle2 size={26} className="text-[#0D69AF] dark:text-blue-400" />
              ...
              <div className="flex gap-6 mt-8">
                <div className="flex-1 bg-[#EAF4FB] dark:bg-blue-900/20 rounded-lg p-6 border-l-4 border-[#0D69AF] dark:border-blue-400 text-center">
                  <div className="font-bold text-[#0D69AF] dark:text-blue-400 mb-2" style={{ fontSize: '32px' }}>более 1500</div>
                  <div className="text-[#6B7280] dark:text-slate-400" style={{ fontSize: '15px' }}>студентов</div>
                </div>
                <div className="flex-1 bg-[#EAF4FB] dark:bg-blue-900/20 rounded-lg p-6 border-l-4 border-[#0D69AF] dark:border-blue-400 text-center">
                  <div className="font-bold text-[#0D69AF] dark:text-blue-400 mb-2" style={{ fontSize: '32px' }}>5</div>
                  <div className="text-[#6B7280] dark:text-slate-400" style={{ fontSize: '15px' }}>специальностей</div>
                </div>
                <div className="flex-1 bg-[#EAF4FB] dark:bg-blue-900/20 rounded-lg p-6 border-l-4 border-[#0D69AF] dark:border-blue-400 text-center">
                  <div className="font-bold text-[#0D69AF] dark:text-blue-400 mb-2" style={{ fontSize: '32px' }}>более 95 лет</div>
          ...
          <div className="flex-[35]">
            <div className="bg-[#F3F4F6] dark:bg-slate-800 rounded-lg flex items-center justify-center" style={{ height: '360px' }}>
              <Camera size={64} className="text-[#9CA3AF] dark:text-slate-500" />
            </div>

            <div className="mt-6 bg-[#EAF4FB] dark:bg-blue-900/20 rounded-lg p-6 border-l-4 border-[#0D69AF] dark:border-blue-400">
              <h3 className="font-bold text-[#0D69AF] dark:text-blue-400 mb-3" style={{ fontSize: '22px' }}>Наши ценности</h3>
