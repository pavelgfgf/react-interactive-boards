...
export const ClockSection: FC<ClockSectionProps> = ({ now }) => {
  ...
  return (
    <section className="text-center py-3">
      <div className="inline-block border-2 border-slate-200 dark:border-slate-700 rounded-2xl px-20 py-5 bg-slate-50 dark:bg-slate-800 shadow-lg shadow-blue-500/10 backdrop-blur-sm relative">
